...
#tinkerbell
cl = LINETCR.LINE()
cl.login(token="EnRlHChxvBlVggxltaje.k6ZXegtsiw8VztzFdQAlFG.UMyqAWv+XTMFBXUD4cwxp9oPiM7uBXrPU2jtPeP4Tq0=")
cl.loginResult()
#vidia
kt = LINETCR.LINE()
kt.login(token="En2d09hOj6wZNH685IUf.my9sNxmVOnOMLr/eVWTsVW.I0kkXUUNrvnGifQiv0H4sgbbuA2WFOru/ec0tX3mGOY=")
kt.loginResult()
#rosetta
ks = LINETCR.LINE()
ks.login(token="EncY6jPHtCtu9TPEUHP0.xD733nq/PpBVPcrMO8XcGa.Lj4d4LuunbfuWvygZkw8eg+JA55R+elqH0BpA4iVo1Q=")
ks.loginResult()
#sirvelmist
ki = LINETCR.LINE()
ki.login(token="EnqmPhuefpEIJcX90Q52.GLLYDNQKp3pag2kwvydcuG.nbYOmXt0MtPTG88yO1c9u94Xe01kPYbrJyuix17C5+Q=")
ki.loginResult()
#fawn
kk = LINETCR.LINE()
kk.login(token="EnnS26K3ncdwerRs2bo9.yGHiWQQ2hVvNYnD3kn2qYq.3fhVKVmUhyN5OpVZFjxQ05eM5IBwUa0S4CVPhZCklNY=")
kk.loginResult()
#iridessa
kc = LINETCR.LINE()
kc.login(token="EnJQVfLoEkHgBHplVnBf.smmwRdi/TsCSmKeWEfJAhW.Irp4fFLK0lPbF4nRyRG2EvDPVHakZeWJDrxjHgiZG3Q=")
kc.loginResult()
...
admin = ["uc85781a179ab73a281215f3834d553fa"]
owner = ["uc85781a179ab73a281215f3834d553fa"]
wait = {
    'contact':False,
    'autoJoin':True,
